 ...
 * 3. Constructorul va fi ales la alegere (Daca o sa implementati constructor cu parametri,
 ...
 * (Perimetrul este suma laturilor unui patrat iar aria este latura la patrat. Atentie:
 * Patratul are toate laturile egale).
 * DREPTUNGHI:
 * 7. Se va crea o clasa Dreptunghi impreuna cu doua proprietati care reprezinta lungimea si latimea
 * 8. Se cere sa se creeze doua metode in clasa, una care calculeaza perimetrul unui dreptunghi,
 * iar unul care calculeaza aria unui dreptunghi.
 * (Perimetrul este suma latimilor si a lungimilor unui dreptunghi iar aria este produsul lungimii
 * cu cel al latimii. Atentie: Dreptunghiul are cate 2 laturi egale).
 *
 ...
 * instantia obiectele cerute si veti folosi obiectele pentru a calcula, dupa caz, perimetrele, ariile.
